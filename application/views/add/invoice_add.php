...
foreach ($max_invoice_number as $irow) 
{
    $INumber = $irow["invoice_no"] + 1;
}
        ...
        <div class="col-xs-12">
            ...
            <div class="box box-primary">
                ...
                <?php
                    ...
                    echo form_open_multipart(base_url('invoice/add'), $attributes);
                ?>
                    <div class="box-body">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="input-group date">
                                    ...
                                    <input class="form-control materialDate" id="invoice_date" type="text" name="invoice_date" placeholder="dd-mm-yyyy" data-inputmask="'alias': 'dd-mm-yyyy'" data-mask>
                                </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="input-group date">
                                    ...
                                    <input readonly id="invoice_no" name="invoice_no" class="form-control" value="<?php echo $INO ?>" type="text" >
                                </div>
