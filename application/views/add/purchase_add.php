...
foreach ($max_purchase_number as $irow) 
{
    $INumber = $irow["purchase_no"] + 1;
}
        ...
        <div class="col-xs-12">
            ...
            <div class="box box-primary">
                ...
                <?php
                    ...
                    echo form_open_multipart(base_url('purchase/add'), $attributes);
                ?>
                    <div class="box-body">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="input-group date">
                                    ...
                                    <input class="form-control materialDate" id="purchase_date" type="text" name="purchase_date" placeholder="dd-mm-yyyy" data-inputmask="'alias': 'dd-mm-yyyy'" data-mask>
                                </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="input-group date">
                                    ...
                                    <input readonly id="purchase_no" name="purchase_no" class="form-control" value="<?php echo $INO ?>" type="text" >
                                </div>
