        ...
        <div class="box-body">
            <div class="row">
                ...
                <div class="col-md-2 col-sm-4 col-xs-12">
                    <a class="btn green-haze btn-outline btn-circle btn-sm btn btn-block btn-default btn-flat" href="<?php echo base_url('quotation/add'); ?>"><i class="fa fa-plus"></i><b> Add New Quotation</b>
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="box-body">
            <ul class="nav nav-tabs cus" role="tablist">
                <li id="all" class="<?php if($hideclass){ echo ""; } else { echo 'active'; } ?>">
                    <a onclick="allshow()" href="<?php echo base_url('quotation/lists'); ?>"><strong>All</strong> </a>
                </li>
            ...
            <div class="<?php if($hideclass){ echo "hideclass"; } else { echo 'activeclasss'; } ?>" id="filtering">
                <?php
                    ...
                    echo form_open_multipart(base_url('quotation/lists'), $attributes);
                ?>
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-group" style="margin-right: 5px">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select class="select_search form-control" id="customer" data-hide-disabled="true" name="customer" data-live-search="true">
        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <a href="<?php echo base_url('quotation/csv'); ?>"><button class="btn green-haze btn-outline btn-sm btn" style="float: left;"><span class="fa fa-download"> &nbsp;</span>Download CSV</button></a>                    
                </div>
                <!-- /.box-header -->
                            ...
                            <tbody>
                                ...
                                <?php foreach ($quotation as $row) { ?>
                                    <tr>
                                        <td>
                                            <?php
                                            echo anchor("quotation/edit/".$row['id'],"<i class='icon-pencil'></i>",array("class" => "btn paddd btn-xs btn-success", "data-toggle" => "tooltip", "data-placement" => "top", "title" => "Edit")).' ';

                                            echo anchor("quotation/delete/".$row['id'],"<i class='icon-trash'></i>",array("onclick" => "return confirm('Do you want delete this record')", "class" => "btn paddd btn-xs btn-danger", "data-toggle" => "tooltip", "data-placement" => "top", "title" => "Delete"));
                                            ?>
                                        </td>
                                        <td><a href="<?php echo base_url('quotation/edit/'.$row['id']) ?>" class="btn paddd btn-xs btn-success"><?php echo $row['quotation_no']; ?></a></td>
                                        <td><?php echo date('d-M Y',strtotime($row['quotation_date'])); ?></td>
                                        <td><?php echo $row['name']; ?></td>
                                        <td><?php echo $row['quotation_payment_method']; ?></td>
                                        <td><?php echo '<label class="btn paddd btn-xs btn-success">'.$row['quotation_grand_total'].'</label>'; ?></td>
                                    </tr>
                                <?php } } else { ?>
                                    <tr>
