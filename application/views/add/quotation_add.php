...
foreach ($max_quotation_number as $irow) 
{
    $INumber = $irow["quotation_no"] + 1;
}
...
$numbers = generate_numbers($INumber, 1, 5);
        ...
        <div class="col-xs-12">
            ...
            <div class="box box-primary">
                ...
                <?php
                    ...
                    echo form_open_multipart(base_url('quotation/add'), $attributes);
                ?>
                    <div class="box-body">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="input-group date">
                                    ...
                                    <input class="form-control materialDate" id="quotation_date" type="text" name="quotation_date" placeholder="dd-mm-yyyy" data-inputmask="'alias': 'dd-mm-yyyy'" data-mask>
                                </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="input-group date">
                                    ...
                                    <input readonly id="quotation_no" name="quotation_no" class="form-control" value="<?php echo $INO ?>" type="text" >
                                </div>
                                    ...
                                    <table class="table table-bordered" id="purchaseInvoice">
                                        <tbody>
                                            ...
                                            <tr class="tableInfo">
                                                ...
                                                <td align="left" colspan="2">
                                                    <input type='text' name="taxTotal" class="form-control" id = "taxTotal" readonly >
                                                </td>
                                            </tr>
                                            <tr class="tableInfo">
                                                ...
                                                <td align="left" colspan="2">
                                                    <input type='text' name="grandTotal" class="form-control" readonly id="grandTotal">
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
