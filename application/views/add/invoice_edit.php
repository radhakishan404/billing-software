        ...
        <div class="col-xs-12">
            ...
            <div class="box box-primary">
                ...
                <?php
                    ...
                    echo form_open_multipart(base_url('invoice/edit/'.$id), $attributes);
                ?>
                    <div class="box-body">
                    <?php echo validation_errors(); ?>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="invoice_customer_name" class="require">Customer</label>
                                <div class="input-group date">
                                    <div class="input-group-addon">
                                        <i class="fa fa-user"></i>
                                    </div>
                                    <select class="select_search form-control" id="invoice_customer_name" data-hide-disabled="true" name="invoice_customer_name" data-live-search="true">
                                        <option value=""></option>
                                        <?php foreach ($customer as $c) { ?>
                                        <option value="<?php echo $c['id']; ?>" <?php echo $invoice[0]['name']==$c['name']?'selected':''; ?>><?php echo $c['name']; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="invoice_payment_method" class="require">Payment Method</label>
                                <div class="input-group date">
                                    <div class="input-group-addon">
                                        <i class="fa fa-dollar"></i>
                                    </div>
                                    <select class="select2 form-control" name="invoice_payment_method" id="invoice_payment_method" data-hide-disabled="true" data-live-search="true" >
                                        <option value="Paypal" <?php echo $invoice[0]['invoice_payment_method']=='Paypal'?'selected':''; ?>>Paypal</option>
                                        <option value="Bank" <?php echo $invoice[0]['invoice_payment_method']=='Bank'?'selected':''; ?>>Bank</option>
                                        <option value="Cash" <?php echo $invoice[0]['invoice_payment_method']=='Cash'?'selected':''; ?>>Cash</option>
                                        <option value="Paytm" <?php echo $invoice[0]['invoice_payment_method']=='Paytm'?'selected':''; ?>>Paytm</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="invoice_date" class="require">Date</label>
                                <div class="input-group date">
                                    <div class="input-group-addon">
                                        <i class="fa fa-calendar"></i>
                                    </div>
                                    <input class="form-control materialDate" id="invoice_date" type="text" name="invoice_date" placeholder="dd-mm-yyyy" data-inputmask="'alias': 'dd-mm-yyyy'" data-mask value="<?php echo date('d-m-Y', strtotime($invoice[0]["invoice_date"])); ?>">
                                </div>
                                <label id="name_error" class="error" style="display: none;">This field is required.</label>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="input-group date">
                                    ...
                                    <input id="invoice_no" name="invoice_no" class="form-control" value="<?php echo $invoice[0]['invoice_no']; ?>" type="text" readonly>
                                </div>
                    ...
                    <div class="box-body">
                                    ...
                                    <table class="table table-bordered" id="purchaseInvoice">
                                        <tbody>
                                            ...
                                            <?php foreach($invoice as $row){ ?>
                                                <tr>
                                                    <td>
                                                        <input type='text' class='form-control text-center' name='item_name[]' value="<?php echo $row['invoice_item_name'] ?>">
                                                    </td>
                                                    <td>
                                                        <input type='text' class='form-control text-center' name='item_hsn[]' value="<?php echo $row['invoice_item_hsn']; ?>">
                                                    </td>
                                                    <td>
                                                        <input type='text' class='form-control text-center custom_units' name='item_qty[]' value='<?php echo $row["invoice_item_qty"]; ?>'>
                                                    </td>
                                                    <td>
                                                        <input type='text' class='form-control text-center custom_rate' name='items_rate[]' value='<?php echo $row['invoice_item_rate'] ?>'>
                                                    </td>
                                                    <td>
                                                        <select class='form-control taxListCustom' name='tax_list[]'>
                                                            <option value='GST@0(0.00)' taxrate='0.00' <?php echo $row['invoice_tax_name']=='GST@0(0.00)'?'selected':''; ?> >GST@0(0.00)</option>
                                                            <option value='GST@12(12.00)' taxrate='12.00' <?php echo $row['invoice_tax_name']=='GST@12(12.00)'?'selected':''; ?> >GST@12(12.00)</option>
                                                            <option value='GST@28(28.00)' taxrate='28.00' <?php echo $row['invoice_tax_name']=='GST@28(28.00)'?'selected':''; ?> >GST@28(28.00)</option>
                                                            <option value='GST@5(5.00)' taxrate='5.00' <?php echo $row['invoice_tax_name']=='GST@5(5.00)'?'selected':''; ?> >GST@5(5.00)</option>
                                                            <option value='GST@3(3.00)' taxrate='3.00' <?php echo $row['invoice_tax_name']=='GST@3(3.00)'?'selected':''; ?> >GST@3(3.00)</option>
                                                            <option value='GST@0.25(0.25)' taxrate='0.25' <?php echo $row['invoice_tax_name']=='GST@0.25(0.25)'?'selected':''; ?> >GST@0.25(0.25)</option>
                                                            <option value='GST@18(18.00)' taxrate='18.00' <?php echo $row['invoice_tax_name']=='GST@18(18.00)'?'selected':''; ?> >GST@18(18.00)</option>
                                                        </select>
                                                    </td>
                                                    <td class='text-center'>
                                                        <input type='text' class='form-control taxAmount' name='taxAmount[]' value="<?php echo $row['invoice_tax_amount'] ?>" readonly >
                                                        
                                                    </td>
                                                    <td>
                                                        <input type='text' class='form-control text-center custom_discount' name='items_discount[]' value='<?php echo $row['invoice_item_discount'] ?>'>
                                                    </td>
                                                    <td>
                                                        <input type='text' class='form-control text-center amount custom_amount' name='items_amount[]' value='<?php echo $row['invoice_item_amount']; ?>' readonly>
                                                    </td>
                                                    <td></td>
                                                </tr>
                                            ...
                                            <tr class="tableInfo">
                                                ...
                                                <td align="left" colspan="2">
                                                    <input type='text' name="subTotal" class="form-control" id = "subTotal" readonly value="<?php echo $invoice[0]['invoice_sub_total']; ?>">
                                                </td>
                                            </tr>
                                            <tr class="tableInfo">
                                                <td colspan="7" align="right"><strong>Total Tax(₹)</strong></td>
                                                <td align="left" colspan="2">
                                                    <input type='text' name="taxTotal" class="form-control" id = "taxTotal" readonly value="<?php echo $invoice[0]['invoice_tax_total']; ?>">
                                                </td>
                                            </tr>
                                            <tr class="tableInfo">
                                                ...
                                                <td align="left" colspan="2">
                                                    <input type='text' name="grandTotal" class="form-control" id = "grandTotal" readonly id="grandTotal" value="<?php echo $invoice[0]['invoice_grand_total']; ?>">
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea placeholder="Description ..." rows="3" class="form-control" name="comments"><?php echo $invoice[0]['invoice_notes']; ?></textarea>
                            </div>
                            <a href="<?php echo base_url('invoice/lists') ?>" class="btn btn-info btn-flat"><b>Cancel</b></a>
...
<script type="text/javascript">
    ...
    $('#btnSubmit').click(function(){
        // customer error
        if($.trim($('#invoice_customer_name').val()).length == 0)
        {
            document.getElementById('customer_error').style.display = 'contents';
            $(window).scrollTop(0);
            return false;
        }
        else
        ...
        {
            document.getElementById('order_error').style.display = 'contents';
            $(window).scrollTop(0);
            return false;
        }
        else
        {
            document.getElementById('order_error').style.display = 'none';
        }
        ...
        {
            alert("You Need to add some data to create Invoice.");
            return false;
        }
