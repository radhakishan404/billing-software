        ...
        <div class="box-body">
            <div class="row">
                ...
                <div class="col-md-2 col-sm-4 col-xs-12">
                    <a class="btn green-haze btn-outline btn-circle btn-sm btn btn-block btn-default btn-flat" href="<?php echo base_url('purchase/add'); ?>"><i class="fa fa-plus"></i><b> Create Purchase</b>
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="box-body">
            <ul class="nav nav-tabs cus" role="tablist">
                <li id="all" class="<?php if($hideclass){ echo ""; } else { echo 'active'; } ?>">
                    <a onclick="allshow()" href="<?php echo base_url('purchase/lists'); ?>"><strong>All</strong> </a>
                </li>
            ...
            <div class="<?php if($hideclass){ echo "hideclass"; } else { echo 'activeclasss'; } ?>" id="filtering">
                <?php
                    ...
                    echo form_open_multipart(base_url('purchase/lists'), $attributes);
                ?>
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-group" style="margin-right: 5px">
                                    <label for="exampleInputEmail1"><b>Supplier</b></label>
                                    <div class="input-group">
                                        <div class="input-group-addon">
                                            <i class="fa fa-user"></i>
                                        </div>
                                        <select class="select2 form-control" id="supplier" data-hide-disabled="true" name="supplier" data-live-search="true">
                                            <option value="">All</option>
                                            <?php foreach ($supplier as $c) { ?>
                                            <option value="<?php echo $c['id']; ?>" <?php if($supplier_name == $c['id']) echo 'selected'; ?>><?php echo $c['name']; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <a href="<?php echo base_url('purchase/csv'); ?>"><button class="btn green-haze btn-outline btn-sm btn" style="float: left;"><span class="fa fa-download"> &nbsp;</span>Download CSV</button></a>                    
                </div>
                <!-- /.box-header -->
                            ...
                            <tbody>
                                ...
                                <?php foreach ($purchase as $row) { ?>
                                    <tr>
                                        <td>
                                            <?php
                                            echo anchor("purchase/edit/".$row['id'],"<i class='icon-pencil'></i>",array("class" => "btn paddd btn-xs btn-success", "data-toggle" => "tooltip", "data-placement" => "top", "title" => "Edit")).' ';

                                            echo anchor("purchase/delete/".$row['id'],"<i class='icon-trash'></i>",array("onclick" => "return confirm('Do you want delete this record')", "class" => "btn paddd btn-xs btn-danger", "data-toggle" => "tooltip", "data-placement" => "top", "title" => "Delete"));
                                            ?>
                                        </td>
                                        <td><a href="<?php echo base_url('purchase/edit/'.$row['id']) ?>" class="btn paddd btn-xs btn-success"><?php echo $row['purchase_no']; ?></a></td>
                                        <td><?php echo date('d-M Y',strtotime($row['purchase_date'])); ?></td>
                                        <td><?php echo $row['name']; ?></td>
                                        <td><?php echo $row['purchase_payment_method']; ?></td>
                                        <td><?php echo '<label class="btn paddd btn-xs btn-success">'.$row['purchase_grand_total'].'</label>'; ?></td>
                                    </tr>
                                <?php } } else { ?>
                                    <tr>
