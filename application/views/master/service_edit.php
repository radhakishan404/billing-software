        ...
        <div class="col-xs-12">
            ...
            <div class="box box-primary">
                ...
                <?php
                    ...
                    echo form_open_multipart(base_url('service/edit/'.$id), $attributes);
                ?>
                    <div class="box-body">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group col-sm-8">
                                    ...
                                    <input type="name" name="name" class="form-control" id="name" placeholder="Enter Name" value="<?php echo $detail[0]['name']; ?>" required>
                                </div>
                    ...
                    <div class="box-footer">
                        <a href="<?php echo base_url('service/lists'); ?>" class="btn btn-info btn-flat">Cancel</a>
