        ...
        <div class="col-xs-12">
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <div class="caption"><i class="icon-equalizer "></i><span class="caption-subject font-green-haze bold uppercase">Package Edit</span></div>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <?php
                    $attributes = array('class' => 'form-horizontal', 'id' => 'add');
                    echo form_open_multipart(base_url('package/edit/'.$id), $attributes);
                ?>
                    <div class="box-body">
                        <div class="col-md-6">
                                ...
                                <div class="input-group col-sm-8">
                                    ...
                                    <select  class="form-control selectname" name="name" id="name" data-hide-disabled="true" data-live-search="true" required>
                                        ...
                                        <?php foreach ($users as $u) { ?>
                                            <option <?php echo $detail[0]['user_id']==$u['id']?'selected':''; ?> value="<?php echo $u['id']; ?>"><?php echo $u['name']; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group col-sm-8">
                                    ...
                                    <input type="text" class="form-control materialDate" id="s_date" name="s_date" placeholder="dd-mm-yyyy" data-inputmask="'alias': 'dd-mm-yyyy'" data-mask value="<?php echo date('d-m-Y', strtotime($detail[0]['start_date'])); ?>">
                                </div>
                                <div class="col-md-offset-4 col-sm-8">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group col-sm-8">
                                    ...
                                    <input type="text" class="form-control materialDate" id="e_date" name="e_date" placeholder="dd-mm-yyyy" data-inputmask="'alias': 'dd-mm-yyyy'" data-mask value="<?php echo date('d-m-Y', strtotime($detail[0]['end_date'])); ?>">
                                </div>
                                <div class="col-md-offset-4 col-sm-8">
