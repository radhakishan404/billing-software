		...
		<div class="col-md-9">
			...
			<div class="box box-default">
				<div class="box-body">
					<div class="row">
						<div class="col-md-9">
							<div class="caption"><i class="glyphicon glyphicon-map-marker"></i><span class="caption-subject font-green-haze bold uppercase">Location Add</span></div>
						</div> 
					</div>
				</div>
			</div>
			<div class="box box-default">
				<?php
                    ...
                    echo form_open_multipart(base_url('company/add'), $attributes);
                ?>
					<div class="form-group">
						<label for="name" class="col-sm-3 control-label require">Location Name </label>
						<div class="col-sm-6">
							<input type="name" name="name" class="form-control" id="name" placeholder="Location Name">
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input type="name" name="address" class="form-control" id="address" placeholder="Delivery Address">
						</div>
						<div class="col-md-offset-3 col-sm-8">
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input type="name" name="phone" class="form-control" id="phone" placeholder="Enter Name" data-inputmask='"mask": "9999999999"' data-mask>
						</div>
						<div class="col-md-offset-3 col-sm-8">
