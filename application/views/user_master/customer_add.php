        ...
        <div class="col-xs-12">
            ...
            <div class="box box-primary">
                ...
                <?php
                    ...
                    echo form_open_multipart(base_url('customer/add'), $attributes);
                ?>
                <?php echo validation_errors(); ?>
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group col-sm-8">
                                    ...
                                    <input type="text" class="form-control" name="mobile" id="mobile" placeholder="Enter Mobile Number"  data-inputmask='"mask": "9999999999"' data-mask>
                                </div>
                                <div class="col-md-offset-4 col-sm-8">
                    ...
                    <div class="box-footer">
                        <a href="<?php echo base_url('customer/lists'); ?>" class="btn btn-info btn-flat">Cancel</a>
