        ...
        <div class="box-body">
            <div class="row">
                ...
                <div class="col-md-2 col-sm-4 col-xs-12">
                    <a class="btn green-haze btn-outline btn-circle btn-sm btn btn-block btn-default btn-flat" href="<?php echo base_url('customer/add'); ?>"><i class="fa fa-plus"></i>  Add New Customer
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <a href="<?php echo base_url('customer/csv'); ?>"><button class="btn green-haze btn-outline btn-sm btn" style="float: left;"><span class="fa fa-download"> &nbsp;</span>Download CSV</button></a>                    
                </div>
                <!-- /.box-header -->
                        ...
                        <table class="table table-striped table-bordered table-advance table-hover" id="item_list">
                            ...
                            <tbody>
                                <?php foreach ($total as $r) { ?>
                                    <tr>
                                        <td><a href="<?php echo base_url('customer/edit/'.$r['id']) ?>" class="btn paddd btn-xs btn-success"><?php echo $r["name"]; ?></a></td>
                                        <td><?php echo $r['email']; ?></td>
                                        <td><?php echo $r['mobile']; ?></td>
                                        <td><?php echo $r['status']==1?'<span class="label label-success">Active</span>':'<span class="label label-danger">Inactive</span>'; ?></td>
                                        <td>
                                            <?php
                                            echo anchor("customer/edit/".$r['id'],"<i class='icon-pencil'></i>",array("class" => "btn paddd btn-xs btn-success", "data-toggle" => "tooltip", "data-placement" => "top", "title" => "Edit")).' ';

                                            echo anchor("customer/delete/".$r['id'],"<i class='icon-trash'></i>",array("onclick" => "return confirm('Do you want delete this record')", "class" => "btn paddd btn-xs btn-danger", "data-toggle" => "tooltip", "data-placement" => "top", "title" => "Delete"));
                                            ?>
                                        </td>
                                    </tr>
                                <?php } ?>
